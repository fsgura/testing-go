...
func main() {
	...
	err := godotenv.Load("C:\\Users\\xiloss\\Go\\src\\github.com\\fsgura\\testing-go\\auth0_rest\\auth0.env")
	if err != nil {
		log.Fatal("Error loading auth0.env file")
	}
	...
	r.PathPrefix("/static/").Handler(http.StripPrefix("/static/", http.FileServer(http.Dir("C:\\Users\\xiloss\\Go\\src\\github.com\\fsgura\\testing-go\\auth0_rest\\static"))))
